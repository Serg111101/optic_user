    ...
    <div className="themes">
      ...
      <div className="paragraph1">
        <p className="p1">
          ...
          use of Best Optic Lab,
        </p>
        <i>
          Inc is located at: <br />
          820 Thompson Ave, Ste 30 , Glendale
          <br /> California - 91201, United States
        </i>
        <p className="p2">
          By accessing this website we assume you accept these terms and
          conditions in full. Do not continue to use Best Optic Lab, Inc's
          ...
          appropriate manner, whether by formal meetings of a fixed duration, or
      ...
      <div className="paragraph2">
        <p>
          We employ the use of cookies. By using Best Optic Lab, Inc's website
          you consent to the use of cookies in accordance with Best Optic Lab,
      ...
      <div className="paragraph3">
        <p>
          Unless otherwise stated, Best Optic Lab, Inc and/or it’s licensors own
          the intellectual property rights for all material on Best Optic Lab,
          Inc. All intellectual property rights are reserved. You may view
          and/or print pages from https://bestopticlab.com/ for your own
        ...
        <p>You must not:</p>
        <p>
          1. Republish material from https://bestopticlab.com/ Sell, rent or{" "}
          <br />
          2. sub-license material from https://bestopticlab.com/ Reproduce, br
          <br />
          3. duplicate or copy material from https://bestopticlab.com/
        </p>
        <p>
          Redistribute content from Best Optic Lab, Inc (unless content is
      ...
      <div>
        ...
        <p>
          1.Government agencies; <br /> 2.Search engines;
          <br />
          3. News organizations; <br />
          4. Online directory distributors when they list us in the directory
          may link to our Web site in the same manner as they hyperlink to the
          Web sites of other listed businesses; <br />
        ...
        <p>
          ...
          requests from the following types of organizations: <br /> <br />{" "}
          <br /> 1.commonly-known consumer and/or business information sources
          such as Chambers of Commerce, American Automobile Association, AARP
          and Consumers Union; <br />
          2. dot.com community sites; <br />
          3.associations or other groups representing charities, including
          charity giving sites, <br />
          4.online directory distributors; <br /> 5.internet portals; <br />
          6. accounting, law and consulting firms whose primary clients are
          businesses; and <br />
          7. educational institutions and trade associations. <br />
        </p>
        ...
        <p>
          ...
          e-mail to <a href="info@bestopticlab.com."> info@bestopticlab.com.</a>
        ...
        <p>
          Approved organizations may hyperlink to our Web site as follows: <br /> 1.By
          use of our corporate name; or <br />
          2. By use of the uniform resource locator (Web address) being linked
          to; or <br />
        ...
        <p>
          No use of Best Optic Lab, Inc’s logo or other artwork will be allowed
