...
export const Step3 = ({step4,step5,setStep4,setStep5}:any) => {
  ...
  return (<>
  {step4?<Step4 step4={step4} step5={step5} setStep4={setStep4} setStep5={setStep5} />:
    ...
    <div className='Step3'>
        <div className='Aaa'>
            <div className='testing'>
                ...
                {test1!==''&&test1!=='test1' && test2!=='' && test2!=='test2' && <button onClick={()=>setStep4(true)}>save</button> }
            </div>
            <div className="img">
                {
                    test1 === 'aaa' ?
