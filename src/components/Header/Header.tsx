...
export function Header() {
    ...
    return (
        <header className="header" style={{ background: LoginStyle?.loginBg_color }}>
            ...
            <div  className="headericone" onClick={()=>setMobile(true)}>
                        {!mobile&&<div onClick={ ()=>setMobile(true)}><MenuOutlined/></div>}
                     </div>
                ...
                <div className= {!mobile?" items":"items-mobile"}  >
                    ...
                    {mobile&&<div className="sasas" id="sasas" onClick={()=>setMobile(false)}><CloseOutlined/></div>}
